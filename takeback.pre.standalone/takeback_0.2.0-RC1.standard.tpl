...
document.querySelector('.search-icon').onmouseover = function () {
	...
	document.querySelector('.hitokoto').style.left = '-100%';
};
/*
document.querySelector('.search-engine').onmouseout = function () {
	document.querySelector('.search-engine').style.display = 'none';
	document.querySelector('.hitokoto').style.opacity = 1;
};
*/
...
for (var i = 0; i < engines.length; i++) {
	...
	engines[i].onclick = function (event) {
		...
		document.querySelector('.search-engine').style.display = 'none';
		document.querySelector('.hitokoto').style.left = '0';
